...
- Network-related errors being shown as "UndeclaredThrowableException"
...
- Enabling the map for devices without Vulkan graphics, like an emulator
...
- Not focusing albums and folders on Android TV 7
- Inability to connect to a library right after disconnecting from one
...
- Redundant encryption of the stored credentials and library connection parameters.
  The data is still securely stored in the app's private folder where no other apps can read it.
  It is just no longer additionally encrypted
...
- Not showing the date in the media viewer if the opened entry has no title

### Changed

- [Memory cards](https://github.com/Radiokot/photoprism-android-client/wiki/Memories-extension)
  no longer move around immediately after being seen, so they behave more like Instagram stories

## [1.35.0] - 2025-02-04

### Added

- Ability to renew an extension activation key issued for another device
...
[1.35.0]: https://github.com/Radiokot/photoprism-android-client/compare/1.34.0(50)...1.35.0(52)
...
[1.41.0]: https://github.com/Radiokot/photoprism-android-client/compare/1.40.1(61)...1.41.0(62)
...
[1.42.2]: https://github.com/Radiokot/photoprism-android-client/compare/1.42.1(64)...1.42.2(65)
...
[1.47.0]: https://github.com/Radiokot/photoprism-android-client/compare/1.46.1(71)...1.47.0(72)

[1.47.1]: https://github.com/Radiokot/photoprism-android-client/compare/1.47.0(72)...1.47.1(73)

[Unreleased]: https://github.com/Radiokot/photoprism-android-client/compare/1.47.1(73)...HEAD
